...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Menu__ = __webpack_require__(28);




__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Menu__["a" /* Menu */], null), document.getElementById('menu'));
...
class Menu extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    componentDidMount() {
        fetch('/Api/Menu').then(data => data.json()).then(response => this.setState({ menues: response }));
    }

    renderChildren(menuItem) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'li',
            { key: menuItem.Id, className: 'nav-item dropdown' },
        ...
        this.state.menues.map(menuItem => {
            ...
            if (menuItem.Children.length > 0) {
                ...
                items.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'li',
                    { key: menuItem.Id, className: 'nav-item' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'a',
                        { className: 'nav-link', key: menuItem.Id },
                        menuItem.Title
                    )
                ));
            }
